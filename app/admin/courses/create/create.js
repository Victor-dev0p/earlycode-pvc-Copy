...
export default function CreateCourseClient() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        router.push(`/admin/courses/${data.courseId}/curriculum`);
      } else {
    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-4xl font-bold text-gray-800">Create New Course</h1>
            <p className="text-gray-600">Fill in the course information below</p>
          </div>
        </div>
