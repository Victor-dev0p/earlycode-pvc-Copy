...
const menuItems = [
  ...
  { icon: UserCheck, label: 'Tutors', href: '/admin/tutors' },
...
export default function AdminSidebar() {
  ...
  return (
    <>
      ...
      <div className="block lg:hidden fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-50 h-16">
        <div className="flex items-center justify-between h-full px-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="font-bold text-gray-800 text-sm">PVC Admin</h1>
      ...
      {mobileMenuOpen && (
        <div 
          className="block lg:hidden fixed inset-0 bg-opacity-30 z-30"
          style={{ top: '64px' }}
      ...
      >
        ...
        <div className="hidden lg:flex p-6 border-b-2 border-gray-100 items-center justify-between flex-shrink-0">
          {!collapsed && (
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="font-bold text-gray-800">PVC Admin</h1>
                <p className="text-xs text-gray-500">Management Panel</p>
              </div>
            </div>
          )}
        ...
        <div className="p-4 border-t-2 border-gray-100 space-y-2 flex-shrink-0">
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-red-600 hover:bg-red-50 transition-colors ${collapsed ? 'lg:justify-center' : ''}`}
