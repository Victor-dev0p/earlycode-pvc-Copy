...
const menuItems = [
  ...
  { icon: ShoppingCart, label: 'My Courses', href: '/student/my-courses' },
  { icon: GraduationCap, label: 'Sessions', href: '/student/sessions' },
      ...
      <div className="block lg:hidden fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-50 h-16">
        <div className="flex items-center justify-between h-full px-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="font-bold text-gray-800 text-sm">PVC Student</h1>
        ...
        <div className="hidden lg:flex p-6 border-b-2 border-gray-100 items-center justify-between flex-shrink-0">
          {!collapsed && (
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="font-bold text-gray-800">PVC Student</h1>
                <p className="text-xs text-gray-500">Learning Portal</p>
              </div>
            </div>
          )}
